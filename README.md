...
R package **mrindustry**, version **0.20.1**
...
Benke F, Dürrwächter J, Rodrigues R, Moreno-Leiva S, Baumstark L, Pehl M, Weiss B (2025). "mrindustry: input data generation for the REMIND industry module." Version: 0.20.1, <https://github.com/pik-piam/mrindustry>.
