...
R package **mrindustry**, version **0.0.2**
...
Benke F (2024). _mrindustry: input data generation for the REMIND industry module_. R package version 0.0.2, <https://github.com/pik-piam/mrindustry>.
