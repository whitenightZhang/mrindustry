...
R package **mrindustry**, version **0.17.1**
...
Benke F, Dürrwächter J, Rodrigues R, Moreno-Leiva S, Baumstark L, Pehl M (2025). "mrindustry: input data generation for the REMIND industry module." Version: 0.17.1, <https://github.com/pik-piam/mrindustry>.
