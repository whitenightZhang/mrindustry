...
R package **mrindustry**, version **0.1.0**
...
Benke F, Dürrwächter J (2024). _mrindustry: input data generation for the REMIND industry module_. R package version 0.1.0, <https://github.com/pik-piam/mrindustry>.
