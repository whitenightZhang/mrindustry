...
R package **mrindustry**, version **0.3.0**
...
Benke F, Dürrwächter J, Rodrigues R, Moreno-Leiva S, Baumstark L, Pehl M (2024). _mrindustry: input data generation for the REMIND industry module_. R package version 0.3.0, <https://github.com/pik-piam/mrindustry>.
